...
function getWeatherdata(Capital){
      ...
      //console.log(temp)
            ...
            .then(response => {
                ...
                console.log(result)
                alert(`Temperature of ${Capital} is `+result.main.temp +' degree celsius' + '\n' +
                `Humidity of ${Capital} is ` +result.main.humidity +' grams per metre cube'  + '\n' +
                `pressure of ${Capital} is ` + result.main.pressure +' kg per metre second square');
